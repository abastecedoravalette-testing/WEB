...
// (ej: tags: ["embutidos"] → aparece en la sección EMBUTIDOS). y todo
const BASE_CUTS = {
  vacuna: [
    {
      name: "1/2 Res",
  ...
  return (
    <section className="w-full py-10 px-4 bg-white">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="border-1 border-l-4 border-green-700 flex items-center gap-4 w-full rounded-r-md bg-green-100 my-15 p-4">
        ...
        <div className="flex flex-col divide-y divide-gray-400 border border-gray-400 rounded-2xl overflow-hidden">
          {TROCEOS.map((t, i) => (
            ...
            >
              <img
                src={t.img}
                className="aspect-square size-25 my-auto flex-shrink-0 group-hover:scale-110 transition-transform"
              />
              ...
              <ArrowUpRight className="size-6 self-center text-gray-400 group-hover:text-[#C0392B] mt-1.5 flex-shrink-0 transition-colors" />
            </button>
          ))}
        </div>
      </div>
  ...
  const handleShare = async () => {
    if (navigator.share) {
      ...
      await navigator.clipboard.writeText(
        "https://abastecedoravalette.com.ar/",
      );
      setCopied(true);
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="keywords"
          content="carnicería Luis Guillón, carniceria Moreno, carne al por mayor GBA Sur, carne al por mayor GBA Oeste, abastecedora Valette, cortes de carne Esteban Echeverría, carnicería Ezeiza, carnicería Monte Grande, carnicería Cañuelas, venta mayorista carne Buenos Aires, carne de cerdo, carne de pollo, carne de vaca, carne para asado, carne para restaurantes, troceo media res, carnicería mayorista"
        />
      ...
      "@graph": [
        {
          ...
          "telephone": ["+5491135534033", "+5491130531313", "+5491155291717"],
          "email": "abastecedoravalette.contacto@gmail.com",
          "openingHours": "Mo-Sa 07:00-15:00",
          "servesCuisine": "Carnicería",
          "priceRange": "$$",
          "image": "https://abastecedoravalette.com/abastecedora-valette-logo.jpg",
          "sameAs": [
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-4">
              ...
              <div className="hidden md:flex items-center gap-1 flex-1 justify-center">
                {navLinks.map((link) => (
                  <a
                    key={link.href}
                    href={link.href}
                    className="text-sm font-semibold text-[#1a2340] hover:text-[#C0392B] px-3 py-2 rounded-lg hover:bg-red-50 transition-colors whitespace-nowrap cursor-pointer select-none"
                  >
                    {link.label}
                  </a>
                ))}
              ...
              <div className="flex items-center gap-4 flex-shrink-0">
                <button
                  ...
                  className="flex items-center cursor-pointer select-none gap-2 bg-[#C0392B] text-white text-sm font-semibold px-4 py-2 rounded-xl hover:bg-[#a93226] active:scale-[.97] transition-all shadow-sm"
                >
            ...
            <div className="relative max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24 flex flex-col md:flex-row md:items-center md:gap-16">
              ...
              <div className="flex-1 mb-10 md:mb-0">
                ...
                <p className="text-gray-300 drop-shadow drop-shadow-main leading-relaxed max-w-sm my-8 sm:text-lg">
                  Somos productores con criadero propio, con la mejor hacienda y
                  te vendemos directo, sin intermediarios.
                  <br />
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <p className="flex text-center gap-2 bg-main/70 text-white/85 text-[11px] px-4 py-2 rounded-b-xl border border-white/20">
                      <ArrowUpRight className="size-5 shrink-0 my-auto" /> Abrí
                      el menu para ver nuestros contactos mayoristas, minoristas
                      y sucursales.
                    </p>
                  </div>
                </div>
